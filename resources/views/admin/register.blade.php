...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/img/food.png') }}" type="image/x-icon">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card">
                                <div class="p-5">
                                    ...
                                    <form action="{{ route('post-register') }}" class="login-form" method="post" enctype="multipart/form-data">
							        {{ csrf_field() }}
                                    <form class="user">
